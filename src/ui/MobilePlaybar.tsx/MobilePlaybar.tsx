...
export default function MobilePlaybar() {
  ...
  return (
    <div class=" h-18 bottom-13 left-0 right-0 overflow-hidden absolute p-1 z-10 sm:hidden">
      <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-700/50 w-full h-full rounded-2xl overflow-hidden">
        <div class="flex flex-row items-center justify-between p-2 h-full">
          ...
          <div class="absolute inset-0 z-5 bg-black/20 rounded-2xl">
            <div class="backdrop-blur-3xl w-full flex items-center h-full">
              <div class="flex justify-between w-full items-center px-2 gap-4">
                ...
                <div class=" h-16 items-center justify-center">
