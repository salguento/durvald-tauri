      ...
      >
        <div class="flex flex-col  gap-3 p-1">
          ...
          <OverlayScrollbarsComponent
            ...
            defer
            class=" relative h-96 overflow-auto bg-zinc-800/50 rounded-xl p-3"
          >
            <div class="flex flex-col gap-3">
              ...
              <span class="text-sm text-zinc-400">
                ...
                advanced, reflecting the work A.G. Cook has done since then. It
                includes the album’s lead single Silver Thread Golden Needle and
                the title track Britpop.
              </span>
              <span class="text-sm text-zinc-400">
                ...
                it includes Without, an ode to the late producer SOPHIE, one of
                Cook’s closest friends and collaborators.
              </span>
              <span class="text-sm text-zinc-400">
                — Future (tracks 17 to 24): This disc showcases avant-garde and
                chaotic sound designs. As A. G. Cook said, Future includes all
                the tracks that almost make him feel uncomfortable, where he
                questions the tempo or genre. It includes the album’s third
