...
// Function
export default function LibraryMenubarDropdownMenu(props: Props) {
          ...
          <div class=" flex flex-col w-full h-full overflow-hidden">
            <DropdownMenu.Item class="bg-transparent hover:bg-zinc-600/50 relative px-2 py-2 flex justify-between rounded-xl  outline-0">
              <div class=" flex gap-2 items-center w-full">
                <span class="icon-[solar--menu-dots-bold] w-4 h-4"></span>
                <span class="">Edit library items</span>
              </div>
            </DropdownMenu.Item>
            ...
            <DropdownMenu.Item class="bg-transparent hover:bg-zinc-600/50 relative px-2 py-2 flex justify-between rounded-xl  outline-0">
              ...
              >
                <span
                  class={`${expandLibrary() ? "icon-[solar--alt-arrow-up-linear]" : "icon-[solar--alt-arrow-down-linear]"} h-4 w-4 `}
                ></span>
                <span class="">{expandLibrary() ? "Collapse" : "Expand"}</span>
              </button>
            </DropdownMenu.Item>
          </div>
